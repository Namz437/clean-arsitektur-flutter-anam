...
class ProdukModel extends Produk {
  ...
  // Konversi Produk ke ProdukModel
  static ProdukModel fromProduk(Produk produk) {
    return ProdukModel(
      id: produk.id,
      namaProduk: produk.namaProduk,
      harga: produk.harga,
      deskripsi: produk.deskripsi,
      jenisProdukUid: produk.jenisProdukUid,
      kategoriProdukUid: produk.kategoriProdukUid,
      gudangUid: produk.gudangUid,
    );
  }

  // Konversi ProdukModel ke Produk
  Produk toProduk() {
    return Produk(
      id: id,
      namaProduk: namaProduk,
      harga: harga,
      deskripsi: deskripsi,
      jenisProdukUid: jenisProdukUid,
      kategoriProdukUid: kategoriProdukUid,
      gudangUid: gudangUid,
    );
  }
}
